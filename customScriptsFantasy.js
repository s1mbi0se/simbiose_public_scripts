...
async function handleBalance() {
	try {
		...
		let user_id = data1[0][0].user_fantasy__user_fantasy_id
		let gold_balls = data1[0][0].user_fantasy__gold_balls_balance     //saldo em bolas de ouro
		let balance = data1[0][0].user_fantasy__balance                   //saldo em dinheiro
		let coin_type1 = coin_types[0][0].table_rules__coin_type_id      //tipo de valor(dinheiro / bolas de ouro)
		if (coin_type1 === null) {
