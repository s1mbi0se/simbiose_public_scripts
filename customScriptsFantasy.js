...
function del_unique_player(id_btn) {
	...
	if (formationSelect[0].value == '3-4-3') {
		if (control_if == 0 || control_if == 15) {
			display_unique_del_player.textContent = "GOL"
		}
		if (control_if == 1 || control_if == 2 || control_if == 3 || control_if == 14) {
			display_unique_del_player.textContent = "ZAG"
		}
		if (control_if == 4 || control_if == 5 || control_if == 6 || control_if == 7 || control_if == 12 || control_if == 13) {
		...
		if (control_if == 4 || control_if == 5 || control_if == 6 || control_if == 7 || control_if == 10 || control_if == 12 || control_if == 13) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 8 || control_if == 9 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		}
		...
		if (control_if == 1 || control_if == 2 || control_if == 14) {
			display_unique_del_player.textContent = "ZAG"
		}
		if (control_if == 3 || control_if == 4 || control_if == 13) {
			display_unique_del_player.textContent = "LAT"
		}
		if (control_if == 5 || control_if == 6 || control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 7 || control_if == 8 || control_if == 9 || control_if == 10 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		}
		...
		if (control_if == 5 || control_if == 6 || control_if == 7|| control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 8 || control_if == 9 || control_if == 10 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		}
		...
		if (control_if == 5 || control_if == 6 || control_if == 7|| control_if == 10 || control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 8 || control_if == 9 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		...
		if (control_if == 5 || control_if == 6 || control_if == 7|| control_if == 8 || control_if == 10 || control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 9) {
			display_unique_del_player.textContent = "ATA"
		...
		if (control_if == 4 || control_if == 5 || control_if == 13) {
			display_unique_del_player.textContent = "LAT"
		}
		if (control_if == 6 || control_if == 7 || control_if == 10|| control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 8 || control_if == 9 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		...
		if (control_if == 6 || control_if == 7 || control_if == 8 || control_if == 10|| control_if == 12) {
			display_unique_del_player.textContent = "MEI"
		}
		if (control_if == 9 || control_if == 11) {
			display_unique_del_player.textContent = "ATA"
		}
	}
...
function disableButtons() {
	...
	disableButton.forEach(element => {
		if (!players_obj_btn.includes(parseInt(element.id)) || players_obj_btn.includes(toString(element.id))) {
...
function sallePlayer(player_id) {
	...
	//Armazeno o id do jogador (Ex:172) na variável player_id_conserved e a variável player_id recebe a posição (ex: p_9)
	...
	let btn = document.getElementById(player_id) //Pega a posição por id (ex: p_9)
	//Remove o CaptainContainer quando o jogador é vendido
	btn.children[3].removeAttribute('style')
	btn.children[0].children[0].classList.remove('captain')
	//Remove o AlertContainer quando o jogador é vendido
	btn.children[4].setAttribute('style', 'display:none')
	btn.children[0].children[0].classList.remove('alert')


	//Aqui varro o objeto players_obj_btn e deleto o player_id_conserved
	let posicao = players_obj_btn.indexOf(parseInt(player_id_conserved))
	players_obj_btn.splice(posicao, 1)


	//Aqui removo a classe salleButton e adiciono novamente a classe buy button, ou seja, troco o botão de vermelho para verde
	let btnBuySaleColor = document.getElementById(player_id_conserved).parentElement.parentElement.children[2].firstElementChild
	btnBuySaleColor.classList.remove('salleButton')
	btnBuySaleColor.classList.add('buyButton')
	//Aqui removo o id do array players_infos
	players_infos.forEach(object => {
...
function joinPlayer(player_id, name) {
	...
	if (!display.classList.contains('preenchido')) {
		...
		j += 1
		players_obj_btn.push(parseInt(player_id))
...
async function handleBalance() {
	try {
		...
		let bet_value = data1[0].table_rules__betting_value            //valor da inscrição
		let user_id = data1[0].user_fantasy__user_fantasy_id
		let gold_balls = data1[0].user_fantasy__gold_balls_balance     //saldo em bolas de ouro
