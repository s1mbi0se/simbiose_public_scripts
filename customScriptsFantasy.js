...
function del_unique_player(id_btn) {
	...
	let val_player = parseFloat(players_obj[id_btn]).toFixed(3)
	let prev_val = parseFloat(cost_team).toFixed(3)
	let subtration = parseFloat(prev_val) - parseFloat(val_player)


	cost_team = subtration.toFixed(3) //parseFloat(players_obj[id_btn]).toFixed(3)



	let prev_value = parseFloat(bal_aval).toFixed(3)
	let new_value = parseFloat(players_obj[id_btn]).toFixed(3)
	let sum = parseFloat(prev_value) + parseFloat(new_value)
    bal_aval = sum.toFixed(3) //parseFloat(players_obj[id_btn]).toFixed(3)
    btn_str = "btn_del_"
    btn_str += id_btn
    span_str = "span_"
    span_str += id_btn
	...
	//balance_available(Object.values(players_obj)[0])
	//team_price(Object.values(players_obj)[0])

	//player_value = Object.values(players_obj)[0]
	//balance_available(player_value)championship
	...
	/*
	players_obj_btn.pop(id_btn)
	let concatId = id_btn
	concatId += 'x2'
	//console.log(concatId)
	//players_obj.find(element => element == concatId)
	delete players_obj[concatId]
	console.log(players_obj_btn)
...
function sallePlayer(player_id){
	...
	for (let i = 0; i < salleBtn.length; i++) {
        salleBtn[i].addEventListener('click', function (event) {
            //console.log('Clicou no vender')

			//no lugar de event.target / document.getElementById(player_id)
			let btnBuyColor = event.target.parentElement.parentElement.children[2].firstElementChild
			//console.log('event', btnBuyColor)
...
function joinPlayer(player_id) {
	//console.log('Entrou na função de comprar')
	j = 0
    ...
    if (!display.classList.contains('preenchido')) {
        ...
        player_value = parseFloat(player_value).toFixed(3)
		...
		//players_obj_btn.push({[pos_player]:player_id})
		//console.log(pos_player)
	...
	//console.log(player_id) //id do jogador do card
	//console.log(pos_player)
	//console.log(retorno[j])
	//console.log(players_obj_btn)
...
function resetNames() {
	...
	document.getElementsByClassName('balance_available')[0].innerText = parseFloat(120.000).toFixed(3)
	document.getElementsByClassName('balance_available')[1].innerText = parseFloat(120.000).toFixed(3)
	document.getElementsByClassName('balance_available')[2].innerText = parseFloat(120.000).toFixed(3)
	document.getElementsByClassName('balance_available')[3].innerText = parseFloat(120.000).toFixed(3)
	document.getElementsByClassName('balance_available')[4].innerText = parseFloat(120.000).toFixed(3)
	document.getElementsByClassName('balance_available')[5].innerText = parseFloat(120.000).toFixed(3)
    document.getElementsByClassName('team_price')[0].innerText =  parseFloat(0.00).toFixed(3)
	document.getElementsByClassName('team_price')[1].innerText =  parseFloat(0.00).toFixed(3)
	document.getElementsByClassName('team_price')[2].innerText =  parseFloat(0.00).toFixed(3)
	document.getElementsByClassName('team_price')[3].innerText =  parseFloat(0.00).toFixed(3)
	document.getElementsByClassName('team_price')[4].innerText =  parseFloat(0.00).toFixed(3)
	document.getElementsByClassName('team_price')[5].innerText =  parseFloat(0.00).toFixed(3)
    ...
    bal_aval = parseFloat(120.000).toFixed(3)
    cost_team = parseFloat(0.00).toFixed(3)
	players_obj = {}
	players_obj_btn = []
	enableButtons()
}
...
function balance_available(discount){
    ...
    element_html_show_balance = parseFloat(element_html_show_balance).toFixed(3)

    discount = parseFloat(discount).toFixed(3)
    bal_aval = parseFloat(bal_aval).toFixed(3)
    element_html_show_balance -=  parseFloat(discount).toFixed(3)

    bal_aval -= parseFloat(discount).toFixed(3)

    document.getElementsByClassName('balance_available')[0].innerText = parseFloat(element_html_show_balance).toFixed(3)
	document.getElementsByClassName('balance_available')[1].innerText = parseFloat(element_html_show_balance).toFixed(3)
	document.getElementsByClassName('balance_available')[2].innerText = parseFloat(element_html_show_balance).toFixed(3)
	document.getElementsByClassName('balance_available')[3].innerText = parseFloat(element_html_show_balance).toFixed(3)
	document.getElementsByClassName('balance_available')[4].innerText = parseFloat(element_html_show_balance).toFixed(3)
	document.getElementsByClassName('balance_available')[5].innerText = parseFloat(element_html_show_balance).toFixed(3)
	...
	//console.log('valor', element_html_show_balance)
	if (element_html_show_balance > 0){
        document.getElementsByClassName('balance_available')[0].style.color = "#444444"
		document.getElementsByClassName('balance_available')[1].style.color = "#444444"
		document.getElementsByClassName('balance_available')[2].style.color = "#444444"
		document.getElementsByClassName('balance_available')[3].style.color = "#444444"
		document.getElementsByClassName('balance_available')[4].style.color = "#444444"
		document.getElementsByClassName('balance_available')[5].style.color = "#444444"
        document.getElementById("btn_save").style.backgroundColor = "#66BC2A"
    }
...
function team_price(value_player){
    value_player = parseFloat(value_player).toFixed(3)
	if(cost_team == 0){
    	cost_team = value_player
	}else{
		let value1 = parseFloat(value_player).toFixed(3)
		let value2 = parseFloat(cost_team).toFixed(3)
		let sum = parseFloat(value1) + parseFloat(value2)
		cost_team = sum.toFixed(3)
	}
